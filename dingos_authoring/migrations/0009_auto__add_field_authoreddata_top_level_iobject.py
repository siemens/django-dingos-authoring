...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AuthoredData.top_level_iobject'
        db.add_column(u'dingos_authoring_authoreddata', 'top_level_iobject',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='top_level_of', null=True, to=orm['dingos.InfoObject']),
                      keep_default=False)

        # Adding M2M table for field yielded_iobjects on 'AuthoredData'
        m2m_table_name = db.shorten_name(u'dingos_authoring_authoreddata_yielded_iobjects')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('authoreddata', models.ForeignKey(orm[u'dingos_authoring.authoreddata'], null=False)),
            ('infoobject', models.ForeignKey(orm[u'dingos.infoobject'], null=False))
        ))
        db.create_unique(m2m_table_name, ['authoreddata_id', 'infoobject_id'])


    def backwards(self, orm):
        # Deleting field 'AuthoredData.top_level_iobject'
        db.delete_column(u'dingos_authoring_authoreddata', 'top_level_iobject_id')

        # Removing M2M table for field yielded_iobjects on 'AuthoredData'
        db.delete_table(db.shorten_name(u'dingos_authoring_authoreddata_yielded_iobjects'))
    ...
    models = {
        ...
        u'dingos_authoring.authoreddata': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {}),
            'top_level_iobject': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'top_level_of'", 'null': 'True', 'to': u"orm['dingos.InfoObject']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True'}),
            'yielded': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'yielded_by'", 'unique': 'True', 'null': 'True', 'to': u"orm['dingos_authoring.AuthoredData']"}),
            'yielded_iobjects': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'yielded_by'", 'symmetrical': 'False', 'to': u"orm['dingos.InfoObject']"})
        },
        ...
        u'dingos_authoring.userauthoringinfo': {
            'Meta': {'object_name': 'UserAuthoringInfo'},
            'default_authoring_namespace_info': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['dingos_authoring.GroupNamespaceMap']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
