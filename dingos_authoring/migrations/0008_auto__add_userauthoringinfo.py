...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserAuthoringInfo'
        db.create_table(u'dingos_authoring_userauthoringinfo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True)),
            ('default_authoring_namespace_info', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dingos_authoring.GroupNamespaceMap'])),
        ))
        db.send_create_signal(u'dingos_authoring', ['UserAuthoringInfo'])


    def backwards(self, orm):
        # Deleting model 'UserAuthoringInfo'
        db.delete_table(u'dingos_authoring_userauthoringinfo')
    ...
    models = {
        ...
        u'dingos_authoring.authoreddata': {
            ...
            'yielded': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'yieled_by'", 'unique': 'True', 'null': 'True', 'to': u"orm['dingos_authoring.AuthoredData']"})
        },
