...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'dingos_authoring_authoreddata', 'processing_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AuthoredData.processing_id'
        db.delete_column(u'dingos_authoring_authoreddata', 'processing_id')
