...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'dingos_authoring_identifier', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal(u'dingos_authoring', ['Identifier'])

        # Adding field 'AuthoredData.identifier'
        db.add_column(u'dingos_authoring_authoreddata', 'identifier',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['dingos_authoring.Identifier']),
                      keep_default=False)


        # Renaming column for 'AuthoredData.name' to match new field type.
        db.rename_column(u'dingos_authoring_authoreddata', 'name_id', 'name')
        # Changing field 'AuthoredData.name'
        db.alter_column(u'dingos_authoring_authoreddata', 'name', self.gf('django.db.models.fields.CharField')(max_length=256))
        # Removing index on 'AuthoredData', fields ['name']
        db.delete_index(u'dingos_authoring_authoreddata', ['name_id'])

        # Adding unique constraint on 'AuthoredData', fields ['group', 'user', 'identifier', 'kind', 'timestamp']
        db.create_unique(u'dingos_authoring_authoreddata', ['group_id', 'user_id', 'identifier_id', 'kind', 'timestamp'])


    def backwards(self, orm):
        # Removing unique constraint on 'AuthoredData', fields ['group', 'user', 'identifier', 'kind', 'timestamp']
        db.delete_unique(u'dingos_authoring_authoreddata', ['group_id', 'user_id', 'identifier_id', 'kind', 'timestamp'])

        # Adding index on 'AuthoredData', fields ['name']
        db.create_index(u'dingos_authoring_authoreddata', ['name_id'])
        ...
        db.delete_table(u'dingos_authoring_identifier')

        # Deleting field 'AuthoredData.identifier'
        db.delete_column(u'dingos_authoring_authoreddata', 'identifier_id')


        # Renaming column for 'AuthoredData.name' to match new field type.
        db.rename_column(u'dingos_authoring_authoreddata', 'name', 'name_id')
        # Changing field 'AuthoredData.name'
        db.alter_column(u'dingos_authoring_authoreddata', 'name_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dingos_authoring.DataName']))
