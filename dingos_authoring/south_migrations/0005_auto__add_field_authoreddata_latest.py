...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AuthoredData.latest'
        db.add_column(u'dingos_authoring_authoreddata', 'latest',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AuthoredData.latest'
        db.delete_column(u'dingos_authoring_authoreddata', 'latest')
