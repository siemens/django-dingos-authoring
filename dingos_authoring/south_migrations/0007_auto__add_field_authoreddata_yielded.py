...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'dingos_authoring_authoreddata', 'yielded',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='yieled_by', unique=True, null=True, to=orm['dingos_authoring.AuthoredData']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AuthoredData.yielded'
        db.delete_column(u'dingos_authoring_authoreddata', 'yielded_id')
