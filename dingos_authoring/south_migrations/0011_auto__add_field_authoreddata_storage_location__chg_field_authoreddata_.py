...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AuthoredData.storage_location'
        db.add_column(u'dingos_authoring_authoreddata', 'storage_location',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


        # Changing field 'AuthoredData.group'
        db.alter_column(u'dingos_authoring_authoreddata', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group'], null=True))

    def backwards(self, orm):
        # Deleting field 'AuthoredData.storage_location'
        db.delete_column(u'dingos_authoring_authoreddata', 'storage_location')


        # User chose to not deal with backwards NULL issues for 'AuthoredData.group'
        raise RuntimeError("Cannot reverse this migration. 'AuthoredData.group' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'AuthoredData.group'
        db.alter_column(u'dingos_authoring_authoreddata', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group']))
