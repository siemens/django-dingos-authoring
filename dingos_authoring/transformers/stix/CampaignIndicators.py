...
from dingos_authoring.transformers.stix.view_classes import BasicSTIXPackageTemplateView

from dingos_authoring.view_classes import BasicProcessingView

import dingos_authoring.forms as observables

from django.templatetags.static import static


FORM_VIEW_NAME = 'dingos_authoring.transformers.stix.campaing_indicators'
...
class stixTransformer:
    ...
    def __process_observables(self):
        ...
        for obs in observables:
            ...
            if True: # try:
                im = importlib.import_module('dingos_authoring.transformers.stix.cybox_object_transformers.' + object_type.lower())
